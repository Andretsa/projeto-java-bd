...
public class VeiculoDAO {
    ...
    public void inserirVeiculo(Veiculo veiculo, int idSegurado) throws SQLException {
        String sql = "INSERT INTO Veiculo (placa, ano, modelo, seguradora,idSegurado) VALUES (?, ?, ?, ?, ?)";
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS)) {
            ...
            preparedStatement.setString(4, veiculo.getSeguradora());
            preparedStatement.setInt(5, idSegurado);
